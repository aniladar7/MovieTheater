...
namespace NetCoreMovieTheater.Areas.Admin.Controllers
{
    ...
    public class MovieController : Controller
    {
        ...
        {
            var olmayanGenres = movieGenderrRepository.GetMovieGenres(Id).ToList();
            var olanGenres = movieGenderrRepository.GetMovieGenres(Id).ToList();

          
            var olanKategoriler =  genreRepository.MoviesGenre(olanGenres);
            ViewBag.genres = genreRepository.GetGenres();
            ViewBag.Olan = olanKategoriler;
